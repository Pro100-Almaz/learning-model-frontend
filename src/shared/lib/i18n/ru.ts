...
export const ru = {
  ...
  dashboard: {
    ...
    qualifyingCount: (n: number, word: string) => `Проходишь на ${n} ${word}`,
    qualifyingNone: 'Пока не проходишь на грант — закроем разрыв',
    equation: (math: number, other: number) => `Математика ${math} + другие ${other}`,
    weakSpotsSub: 'Слабее всего — начни отсюда',
    weakSpotsAll: 'Вся аналитика',
    weakSpotsEmpty: 'Слабых тем нет',
    weakSpotsEmptyBody: 'Хорошая форма. Пройди новый пробный, чтобы проверить себя.',
    grantsHeading: 'Проходишь на грант',
    grantsAll: 'Все проходные',
    grantsEmptyBody: 'Закрой разрыв по слабым темам — и балл дотянется до проходного.',
    quickHeading: 'Быстрые действия',
    quickMock: 'Пройти пробный',
    quickMockSub: 'Обновить прогноз',
    quickCatalog: 'Все темы',
    quickCatalogSub: 'Каталог уроков',
    lessonsCount: (n: number, word: string) => `${n} ${word}`,
  },
